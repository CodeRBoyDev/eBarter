...
<nav class="navbar navbar-default headedcolor">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo e(route('home')); ?>">e-Barter</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                <form action="<?php echo e(route('item.search')); ?>" class="navbar-form navbar-left">
                ...
                <li>
                    <a href="<?php echo e(route('barterlist')); ?>"> 
                        <i class="fas fa-hands-helping" aria-hidden="true"></i> Barter List
                        <span class="totalcolor ">(<?php echo e($total); ?>)</span>
                    </a>
                </li>
                <li class="dropdown">
...
</nav><?php /**PATH C:\BarterSystem\resources\views/partials/header.blade.php ENDPATH**/ ?>