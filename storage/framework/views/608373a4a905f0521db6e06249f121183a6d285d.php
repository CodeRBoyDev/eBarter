            ...
            <div class="profile">
               <div class="profile-header">
                  ...
                  <div class="profile-header-content">
                     ...
                     <img src="<?php echo e(($profile->profilephoto)); ?>" alt="">
                     </div>
                     <!-- END profile-header-img -->
                     <!-- BEGIN profile-header-info -->
                     <div class="profile-header-info">
                        <h4 class="m-t-10 m-b-5"><?php echo e($profile->name); ?> <?php echo e($profile->lname); ?></h4>
                        <p class="m-b-10"><?php echo e($profile->email); ?>/<?php echo e($profile->phone); ?></p>
                        <p class="m-b-10"><?php echo e(auth()->user()->role); ?></p>
                        <a href="<?php echo e(route('user.edit',$profile->id)); ?>" class="btn btn-sm btn-info mb-2">Edit Profile</a>
                     </div>
                  ...
                  <ul class="profile-header-tab nav nav-tabs">
                     ...
                     <li class="nav-item"><a href="#profile-videos" class="nav-link" data-toggle="tab">REQUEST</a></li>
                        ...
                        <script type="text/javascript">
                            $(function () {
                                var table = $('.yajra-dt').DataTable({
                                    processing: true,
                                    serverSide: true,
                                    ajax: "<?php echo e(route('admin.index')); ?>",
                                    columns: [{
                                            data: 'DT_RowIndex',
                                            name: 'DT_RowIndex'
                                        },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\BarterSystem\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>